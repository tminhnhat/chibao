...
study(title='[STRATEGY][RS]ZigZag PA Strategy V4.1 MOD', overlay=true)
...
plot(sz, title='zigzag', color=white, linewidth=2)
...
alertcondition(target01_buy_entry, title='Buy Long 1', message='long')
alertcondition(target01_buy_close, title='Close Long 1', message='close')
alertcondition(target01_sel_entry, title='Buy Short 1', message='short')
alertcondition(target01_sel_close, title='Close Short 1', message='close')
...
alertcondition(target02_buy_entry, title='Buy Long 2', message='long')
alertcondition(target02_buy_close, title='Close Long 2', message='close')
alertcondition(target02_sel_entry, title='Buy Short 2', message='short')
alertcondition(target02_sel_close, title='Close Short 2', message='close')
